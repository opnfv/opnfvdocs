=========================================================
Installation instruction using <xyz> as a deployment tool
=========================================================
Colorado 1.0
------------
...
Feature configuration options can be found at the bottom of this document.
.. I'm sure there is a better way of framing this.....
...
=====================
Each Feature Project will provide an outline of the configuration steps required to implement their feature (this can be generic or on a per installer basis)
