...
* The OPNFV overview document provides a high level overview of the OPNFV release.
  ...
  * http://artifacts.opnfv.org/opnfvdocs/docs/overview/index.rst
...
* The installation & configuration guide will guide users on how to decide which scenario
  ...
  * http://artifacts.opnfv.org/opnfvdocs/docs/installationprocedure/index.rst

* The user guide provides an overview of how to work with the OPNFV platform once installed.

  * http://artifacts.opnfv.org/opnfvdocs/docs/userguide/index.rst
...
.. _Apex installation instruction: http://artifacts.opnfv.org/apex/docs/installation-instructions/index.rst
.. _Compass installation instruction: http://artifacts.opnfv.org/compass4nfv/docs/configguide/index.rst
.. _Fuel installation instruction: http://artifacts.opnfv.org/fuel/docs/installationprocedure/index.rst
.. _Joid installation instruction: http://artifacts.opnfv.org/joid/docs/configguide/index.rst


Project release documentation
=============================

.. a place for projects who maintain their own release library of sorts to publish it
...
.. _copper configuration guide: http://artifacts.opnfv.org/copper/docs/configguide/index.rst
.. _copper user guide: http://artifacts.opnfv.org/copper/docs/userguide/index.rst
...
.. here we can publish gap alanysis and requirement docs
