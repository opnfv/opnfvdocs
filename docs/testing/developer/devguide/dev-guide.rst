...
============================================
Resiliency, Stress and Long Duration Testing
============================================
...
**Resiliency** testing evaluates the ability of SUT to recover in face of fault,
failure or disrupts in normal operation or simply the ability of SUT absorbing
"disruptions".

It could take different forms of inputs that causing "disruptions" while
stress testing only takes some kind of "load" as input.
...
circumstances. In Danube and Euphrates, we only considered the resiliency test
with "load" input, i.e., stress testing, over OPNFV Platform.
