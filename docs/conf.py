...
release = 'Latest'
branch = 'latest'
# Replace 'version', 'release', and 'branch' above with the following
#   when stable Gambia starts:
# version = 'Gambia'
# release = 'Gambia'
...
intersphinx_mapping = {}
intersphinx_mapping['releng'] = ('https://opnfv-releng.readthedocs.io/en/%s' % branch, None)
