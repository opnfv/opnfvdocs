...
* Hardware: Infra working group, Pharos project and associated activities
...
only in the validation of the scenarios themselves where complexity increases. For example, there are test
