...
The spefifications can be accessed using the following link:
...
Testing projects, like ViNePERF and StorPerf provide testing tools to assess certain characteristics of cooud
infrastructures while the Functest testing framework provides and automatic testsuite to test the cloud infrastructures.
The testing projects and frameworks have their release notes, installation and user guides in the
aggregated documentation set referred here:
